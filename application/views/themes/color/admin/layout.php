...
<head>
	...
	<link href="<?php echo $base ?>assets/plugins/jquery-ui/themes/base/minified/jquery-ui.min.css" rel="stylesheet" />
	<link href="<?php echo $base ?>assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
	<link href="<?php echo $base ?>assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
	<link href="<?php echo $base ?>assets/css/animate.min.css" rel="stylesheet" />
	<link href="<?php echo $base ?>assets/css/style.min.css" rel="stylesheet" />
	<link href="<?php echo $base ?>assets/css/style-responsive.min.css" rel="stylesheet" />
	<link href="<?php echo $base ?>assets/css/theme/default.css" rel="stylesheet" id="theme" />
	<!-- ================== END BASE CSS STYLE ================== -->
...
<body>
	...
	<!-- ================== BEGIN BASE JS ================== -->
	<script src="<?php echo $base ?>assets/plugins/jquery/jquery-1.9.1.min.js"></script>
	<script src="<?php echo $base ?>assets/plugins/jquery/jquery-migrate-1.1.0.min.js"></script>
	<script src="<?php echo $base ?>assets/plugins/jquery-ui/ui/minified/jquery-ui.min.js"></script>
	<script src="<?php echo $base ?>assets/plugins/bootstrap/js/bootstrap.min.js"></script>
	<!--[if lt IE 9]>
		<script src="<?php echo $base ?>assets/crossbrowserjs/html5shiv.js"></script>
		<script src="<?php echo $base ?>assets/crossbrowserjs/respond.min.js"></script>
		<script src="<?php echo $base ?>assets/crossbrowserjs/excanvas.min.js"></script>
	<![endif]-->
	<script src="<?php echo $base ?>assets/plugins/slimscroll/jquery.slimscroll.min.js"></script>
	<script src="<?php echo $base ?>assets/plugins/jquery-cookie/jquery.cookie.js"></script>
	<!-- ================== END BASE JS ================== -->
	
	<!-- ================== BEGIN PAGE LEVEL JS ================== -->
	<script src="<?php echo $base ?>assets/js/apps.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->
